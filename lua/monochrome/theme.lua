...
function M.load_syntax()
	local syntax = {
		...
		-- this is a comment
		TSComment = { fg = colors.base00, style = "italic" },
		...
		TSFunction = { fg = colors.base3 },
		TSFuncBuiltin = { fg = colors.gray4 },
		TSFuncMacro = { fg = colors.gray6 },
		TSInclude = { fg = colors.gray7 },
		TSKeyword = { fg = colors.base2 },
		TSKeywordFunction = { fg = colors.base2 },
...
function M.load_plugin_syntax()
	local plugin_syntax = {
		...
		ALEError = { fg = colors.abs_red },
		ALEWarning = { fg = colors.orange },
		ALEInfo = { fg = colors.orange },
		ALEErrorSign = { fg = colors.abs_red },
		...
		LspDiagnosticsVirtualTextError = { fg = colors.abs_red },
		LspDiagnosticsSignError = { fg = colors.abs_red },
		LspDiagnosticsFloatingError = { fg = colors.abs_red },
		...
		LspDiagnosticsVirtualTextHint = { fg = colors.abs_red },
		LspDiagnosticsSignHint = { fg = colors.fg },
		LspDiagnosticsFloatingHint = { fg = colors.fg },
		LspDiagnosticsUnderlineError = { bg = colors.bg, style = "undercurl", sp = colors.abs_red },
